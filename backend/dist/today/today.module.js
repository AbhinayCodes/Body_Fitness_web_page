...
exports.TodayModule = TodayModule = __decorate([
    (0, common_1.Module)({ imports: [schedule_module_1.ScheduleModule, nutrition_module_1.NutritionModule], controllers: [today_controller_1.TodayController], providers: [today_service_1.TodayService] })
], TodayModule);
