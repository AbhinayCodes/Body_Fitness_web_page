...
exports.ReminderModule = ReminderModule = __decorate([
    (0, common_1.Module)({ imports: [schedule_module_1.ScheduleModule, progress_module_1.ProgressModule], controllers: [reminder_controller_1.ReminderController], providers: [reminder_service_1.ReminderService] })
], ReminderModule);
