...
const update_reminder_settings_dto_1 = require("./dto/update-reminder-settings.dto");
...
let ReminderController = class ReminderController {
    ...
    settings(userId) { return this.reminders.getSettings(userId); }
    update(userId, payload) { return this.reminders.updateSettings(userId, payload); }
    today(userId) { return this.reminders.getToday(userId); }
};
...
], ReminderController.prototype, "settings", null);
__decorate([
    (0, common_1.Put)('settings'),
    __param(0, (0, authenticated_user_decorator_1.CurrentUserId)()),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_reminder_settings_dto_1.UpdateReminderSettingsDto]),
    __metadata("design:returntype", void 0)
...
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", void 0)
], ReminderController.prototype, "today", null);
