...
exports.RecipeModule = RecipeModule = __decorate([
    (0, common_1.Module)({ controllers: [recipe_controller_1.RecipeController], providers: [recipe_repository_1.RecipeRepository, recipe_service_1.RecipeService], exports: [recipe_repository_1.RecipeRepository, recipe_service_1.RecipeService] })
], RecipeModule);
